...
def convert_detection_to_panoptic_coco_format(
    input_json_file, segmentations_folder, output_json_file, categories_json_file
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_json_file", type=str, help="JSON file with detection COCO format"
    )
    parser.add_argument(
        "--output_json_file", type=str, help="JSON file with panoptic COCO format"
    )
    parser.add_argument(
        "--segmentations_folder",
        type=str,
