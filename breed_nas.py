...
DIR_COW200 = os.path.join(DIR_DATA, "3_breed", "tv" ) ##need to change for each dataset --------------------
...
def main(args):
    ...
    suffix = args.suffix
    folder_name_string = suffix+"_breed"+f"_{yolo_base}_{n_train}_{i}"  ##need to change for each dataset --------------------
    ...
    # log
    print("----------------------------------------------------------------------------")
    print(f"n_train: {n_train}, breed_yolo_base: {yolo_base}, i: {i}, {suffix}")
    print("----------------------------------------------------------------------------")
    ...
    name_task = f"n{n_train}_{yolo_base}_i{i}"+"_breed"   #### need to change for each dataset ------------------------
