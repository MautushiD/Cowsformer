...
DIR_COW200 = os.path.join(DIR_DATA, "2_light", "tv" ) ##need to change for each dataset --------------------
...
def main(args):
    ...
    suffix = args.suffix
    folder_name_string = suffix+"_light"+f"_{yolo_base}_{n_train}_{i}"  ##need to change for each dataset --------------------
    ...
    name_task = f"n{n_train}_{yolo_base}_i{i}"+"_light"   #### need to change for each dataset ------------------------
